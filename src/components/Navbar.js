...
function Navbar() {
    ...
    return (
        <header className="w-full px-32 py-8 font-medium flex items-center justify-between realtive md:px-12 sm:px-8 lg:px16">
            ...
            >
                <span
                    className={`bg-dark dark:bg-light h-0.5 block transition-all duration-300 ease-out  w-6 rounded-sm ${isOpen ? "rotate-45 translate-y-1" : "-translate-y-0.5"
                        } `}
                ></span>
                <span
                    className={`bg-dark dark:bg-light h-0.5 block transition-all duration-300 ease-out  w-6 rounded-sm my-0.5 ${isOpen ? "opacity-0" : "opacity-100"
                        }`}
                ></span>
                <span
                    className={`bg-dark dark:bg-light h-0.5 block transition-all duration-300 ease-out  w-6 rounded-sm  ${isOpen ? "-rotate-45 -translate-y-1" : "translate-y-0.5"
